...
CREATE POLICY "Block all access" ON "accounts" AS PERMISSIVE FOR ALL TO public USING (false);--> statement-breakpoint
...
CREATE POLICY "Block all access" ON "sessions" AS PERMISSIVE FOR ALL TO public USING (false);--> statement-breakpoint
...
CREATE POLICY "Block all access" ON "verification_tokens" AS PERMISSIVE FOR ALL TO public USING (false);
