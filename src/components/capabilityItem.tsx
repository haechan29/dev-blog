...
const capabilityItemProps: CapabilityItemProps[] = [
  {
    ...
    description: '구글이 권장하는 앱 아키텍처와 Jetpack 라이브러리를 활용합니다. Coroutines을 사용하여 반응형 프로그래밍을 구현합니다.',
  ...
  },
  {
    ...
    description: 'UI 테스트, 유닛 테스트 작성 경험이 있습니다. 자동 배포 환경을 구성하여 효율적으로 작업합니다.',
  ...
  },
  {
    ...
    description: '다양한 프런트엔드 플랫폼에 열정이 있습니다. React와 Next.js를 활용한 사이드 프로젝트 경험이 있습니다.',
