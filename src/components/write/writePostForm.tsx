...
export default function WritePostForm(params: {
    ...
    <div className='w-[100vw] h-full overflow-x-hidden'>
      <div
        className={clsx(
          ...
          params.writePostForm.currentStepId === 'upload' &&
            '-translate-x-[100vw]'
        )}
      >
        <div className='w-[100vw] h-full overflow-y-auto scrollbar-hide px-4 lg:px-8 lg:pb-8'>
          <WritePostContent {...params} />
        </div>
        <div className='w-[100vw] h-full px-4 md:px-40 lg:56 xl:px-72'>
          <WritePostMeta {...params} />
        </div>
      </div>
    </div>
  );
