...
export default function WritePostPrivacy() {
  ...
  const onToggle = useCallback(() => {
    dispatch(setVisibility(visibility === 'private' ? 'public' : 'private'));
  }, [dispatch, visibility]);
