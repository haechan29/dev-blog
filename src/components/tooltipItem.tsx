...
export default function TooltipItem({ text, children, position = 'top' }: TooltipProps) {
  ...
  const arrowClasses = {
    ...
    bottom: 'bottom-full left-1/2 transform -translate-x-1/2 border-l-transparent border-r-transparent border-t-transparent border-l-4 border-r-4 border-b-4 border-b-gray-800',
    ...
    right: 'right-full top-1/2 transform -translate-y-1/2 border-t-transparent border-b-transparent border-l-transparent border-t-4 border-b-4 border-r-4 border-r-gray-800',
  };
